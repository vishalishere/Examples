...
namespace LicensePlate
{
    class LprCtrl : IDisposable
    {
        ...
        public bool ResetResults()
        {
            ...
            if (dResultData!=null )
            {
                if (dResultData.ContainsKey("text"))
                    dResultData["text"] = "";
                if (dResultData.ContainsKey("time"))
                    dResultData["time"] = "";
                if (dResultData.ContainsKey("jurisdiction"))
                    dResultData["jurisdiction"] = "";
                if (dResultData.ContainsKey("confidence"))
                    dResultData["confidence"] = "";
            }
